...
//		fourthOctet = Utility.oneByteToInteger(address[3]);
		firstOctet = Utility.XORoneByteToInteger(address[0], magicCookie_b1);
		secondOctet = Utility.XORoneByteToInteger(address[1], magicCookie_b2);
		thirdOctet = Utility.XORoneByteToInteger(address[2], magicCookie_b3);
		fourthOctet = Utility.XORoneByteToInteger(address[3], magicCookie_b4);
	}
