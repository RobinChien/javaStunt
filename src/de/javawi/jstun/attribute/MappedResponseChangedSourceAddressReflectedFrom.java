...
public class MappedResponseChangedSourceAddressReflectedFrom extends MessageAttribute {
	...
	protected static MappedResponseChangedSourceAddressReflectedFrom parse(MappedResponseChangedSourceAddressReflectedFrom ma, byte[] data) throws MessageAttributeParsingException {
		try {
			...
			int magicCookie_b1 = 0x21;
			int magicCookie_b2 = 0x12;
			int magicCookie_b3 = 0xA4;
			int magicCookie_b4 = 0x42;
			byte[] portArray = new byte[2];
			System.arraycopy(data, 2, portArray, 0, 2);
			ma.setPort(Utility.twoBytesToInteger(portArray));
			int firstOctet = Utility.XORoneByteToInteger(data[4], magicCookie_b1);
			int secondOctet = Utility.XORoneByteToInteger(data[5], magicCookie_b2);
			int thirdOctet = Utility.XORoneByteToInteger(data[6], magicCookie_b3);
			int fourthOctet = Utility.XORoneByteToInteger(data[7], magicCookie_b4);
